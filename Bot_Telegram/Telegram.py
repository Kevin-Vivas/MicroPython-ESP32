...
def main():
    ...
    updater = Updater("5972374693:AAG5IjdOPbcjpHLyn0FnMKnp9nsS9D9sxwA", use_context=True)
    ...
    dp.add_handler(CommandHandler("led1_on",Led1_On))
